...
const WhySpecial = () => {
    return (
        <div className='grid md:grid-cols-2 my-10'>
            <div className='relative p-5 md:p-1'>
                <figure className='md:w-3/4'><img className='rounded-xl w-full' src="https://i.pinimg.com/564x/5b/c4/db/5bc4db3d90a2c468015c0d8ae9d5d64b.jpg" alt="" /></figure>
                <figure className='w-1/4 md:w-2/5 absolute -translate-x-[50%] -translate-y-[50%] left-[50%] md:left-[75%] top-[50%]'><img className='w-full' src="https://freepngimg.com/download/play_button/25746-6-play-button.png" alt="" /></figure>
            </div>
            <div>
                ...
                <div className='mt-5 p-5 md:p-1 flex gap-6'>
